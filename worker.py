...
print("[*] Initializing VERTEX PRO Raw Video Slicer for CapCut...")
...
# 3. Process & Slice Clips in Native 16:9
for clip_item in clips:
    ...
    # Re-encode to standard 1080p MP4 (H.264/AAC) for instant CapCut compatibility
    print(f"[*] Formatting native 16:9 MP4 for CapCut...")
    cmd_render = [
    ...
    print(f"[✓] Ready for CapCut: {out_mp4}")

print("\n[*] All clips downloaded and formatted successfully!")
